function latest() {
    const card_title = "Kryształ Jedności";
    const site_title = card_title;
    const card_cost = "50M";
    const card_cost_info = "50 Many";
    const card_type = "Akcja";
    const card_description = `
        <p>
        Zagrywane przez ciebie karty nie mają kosztów zagrywania.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/100.webp";
