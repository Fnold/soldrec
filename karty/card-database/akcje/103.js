function latest() {
    const card_title = "Syfon";
    const site_title = card_title;
    const card_cost = "12M";
    const card_cost_info = "12 Many";
    ...
    const card_description = `
        ...
        <p>
        Ten wróg traci 10 zdrowia. Zyskujesz 10 zdrowia.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/103.webp";
