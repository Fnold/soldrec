function latest() {
    ...
    const card_description = `
        <p>
        Poświęć jednostkę. Jeżeli jej poświęcenie wywołałoby efekt to dzieje się on dodatkowy raz.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/105.webp";
...
function alpha() {
    ...
    const card_description = `
        <p>
        Poświęć sojuszniczą jednostkę. Jeżeli jej poświęcenie wywołałoby efekt to dzieje się on dodatkowy raz.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Fnold 2024
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/105.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
