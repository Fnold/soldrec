function latest() {
    const card_title = "Powrót Rycerza 1";
    ...
    const card_description = `
        <p>
        Wszystkie wystawione jednostki zyskują status UNICESTWIENIA.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/106.webp";
...
function alpha() {
    ...
    const card_description = `
        <p>
        Wszystkie wystawione jednostki otrzymują status UNICESTWIENIA.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Soldik 2024
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/106.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
