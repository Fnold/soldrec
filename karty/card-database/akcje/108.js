function latest() {
    ...
    const card_description = `
        <p>
        Za każdym razem, gdy zagrywasz jednostkę, twoi wrogowie tracą X zdrowia, gdzie X jest liczbą kolorów tej jednostki.
        </p>`;
    const card_flavor = `
        <i>
        Nie był on tylko ostrzeżeniem.
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/108.webp";
...
function alpha() {
    ...
    document.getElementById("card_flavor").innerHTML = card_flavor;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/108.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
