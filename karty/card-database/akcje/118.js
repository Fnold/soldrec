function latest() {
    ...
    const card_description = `
        ...
        <p>
        Ta jednostka zyskuje +5/&NoBreak;+0/&NoBreak;+5/&NoBreak;+0.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/118.webp";
