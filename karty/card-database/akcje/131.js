function latest() {
    ...
    const card_description = `
        ...
        <p>
        Ta jednostka zyskuje +0/&NoBreak;+0/&NoBreak;+0/&NoBreak;+4.
        </p>
        <p>
        Oddanie(Z): Ta jednostka zyskuje +0/&NoBreak;+0/&NoBreak;+0/&NoBreak;+6.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/131.webp";
