function latest() {
    const card_title = "Utworzenie Raptowników";
    ...
    const card_description = `
        <p>
        Za każdym razem, gdy gracz zagrywa jednostkę, ten gracz kładzie licznik na wybranej jednostce, której jest włodarzem. Następnie jeżeli wszyscy gracze oprócz jednego mają wystawioną jednostkę z licznikiem położonym tym sposobem, ten gracz zmienia stronę wszystkich jednostek z tym licznikiem na swoją, usuń wszystkie te liczniki i usuń z gry tę akcję.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/133.webp";
