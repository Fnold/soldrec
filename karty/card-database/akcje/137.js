function latest() {
    ...
    const card_description = `
        <p>
        Zapłać 2*X many lub X monet: Zyskujesz X monet lub 2*X many.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/137.webp";
