function latest() {
    const card_title = "Tego Nigdy Nie Było";
    ...
    const card_description = `
        <p>
        Wybierz wystawioną kartę.
        </p>
        <p>
        Ta karta zostaje usunięta z gry.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/145.webp";
