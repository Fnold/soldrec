function latest() {
    const card_title = "Marsz Potępionych";
    ...
    const card_description = `
        <p>
        Każda wystawiona jednostka zostaje zajęta.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/146.webp";
...
function v1_1_0() {
    ...
    const card_description = `
        <p>
        Ztapuj każdą wystawioną jednostkę.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Soldin 2024
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/1.1.0/akcje/146.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_1_0_selector").innerHTML = `&gt;<u>v1.1.0</u>`;
}
