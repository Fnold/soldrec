function latest() {
    ...
    const card_description = `
        <p>
        Spójrz na górną kartę wybranej talii, możesz dać tę kartę na spód tej talii. Dobierz 1 kartę.
        </p>`;
    const card_flavor = `
        <i>
        Momenty przed tragedią.
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/147.webp";
