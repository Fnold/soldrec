function latest() {
    const card_title = "Chytruski Ziggurat";
    ...
    const card_description = `
        <p>
        Za każdym razem, gdy twój wróg zagrywa akcję, ten wróg zrzuca 1.
        </p>`;
    const card_flavor = `
        <i>
        "Przenajświętsza Świątynia Chytrusowa i ON sam na jej otwarciu"
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/148.webp";
