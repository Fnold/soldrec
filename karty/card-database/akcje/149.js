function latest() {
    ...
    const card_description = `
        <p>
        Wszystkie instancje zyskiwania przez ciebie zdrowia dzieją się podwójnie.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/149.webp";
