function latest() {
    ...
    const card_description = `
        ...
        <p>
        Za każdym razem, gdy ten wróg zagrywa kartę, traci on 3 zdrowia.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/151.webp";
