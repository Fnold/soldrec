function latest() {
    const card_title = "Zbroja Mike'a";
    ...
    const card_description = `
        ...
        <p>
        Ta jednostka zyskuje X pkt pancerza, gdzie X jest liczbą kart w twojej ręce. Zyskujesz 3 zdrowia.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Mixiq 2024
        </i>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/152.webp";
