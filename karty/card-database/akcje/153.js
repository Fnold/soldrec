function latest() {
    const card_title = "Dnowy Dekret";
    const site_title = card_title;
    const card_cost = "4Z 5M";
    const card_cost_info = "4 Zdrowia i 5 Many";
    const card_type = "Akcja - NATYCH.";
    const card_description = `
        <p>
        Przeszukaj swoją talię po kartę i pokaż ją. Przetasuj swoją talię i umieść tę kartę na górze swojej talii.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/153.webp";
