function latest() {
    const card_title = "Plaga";
    const site_title = card_title;
    const card_cost = "2Z 2M";
    const card_cost_info = "2 Zdrowia i 2 Many";
    const card_type = "Akcja - PLAN";
    const card_description = `
        <p>
        Adwansuj za każdym razem, gdy umiera wroga jednostka lub gdy przeprowadzane jest starcie.
        </p>
        <p>
        1 - Każdy twój wróg zrzuca 1 kartę.
        </p>
        <p>
        2 - Każdy twój wróg zrzuca 2 karty.
        </p>
        <p>
        3 - Każdy twój wróg zrzuca 3 karty.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/154.webp";
