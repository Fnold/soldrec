function latest() {
    const card_title = "Szarża Berty";
    const site_title = card_title;
    const card_cost = "6M 16P";
    const card_cost_info = "6 Many i 16 Popularności";
    ...
    const card_description = `
        ...
        <p>
        Ta jednostka zyskuje KRWAWIENIE 7.
        </p>
        <p>
        Domena Bestii: Ta jednostka umiera. Włodarz tej jednostki zostaje zatruty. Ulepsz każdą sojuszniczą jednostkę.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/156.webp";
