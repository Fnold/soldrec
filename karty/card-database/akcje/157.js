function latest() {
    const card_title = "Portal Serutusa";
    const site_title = card_title;
    const card_cost = "8P";
    const card_cost_info = "8 Popularności";
    ...
    const card_description = `
        ...
        <p>
        Zmień ułożenie wystawienia sojuszniczych jednostek.
        </p>
        <p>
        Oddanie(Y): Zmień ułożenie wystawienia sojuszniczych i/lub wrogich jednostek.
        </p>`;
    const card_flavor = `
        <i>
        Najazd na posiadłość Evader'a nie okazał się końcem cierpień...
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/157.webp";
