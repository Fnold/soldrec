function latest() {
    ...
    const card_description = `
        ...
        <p>
        Oddanie(C): Zyskujesz 1 zdrowia.
        </p>`;
    const card_flavor = `
        <i>
        "Herbert pamięta każde wyjątkowe miejsce. W żadnym z nich kwiat się nigdy nie przyjął."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/158.webp";
