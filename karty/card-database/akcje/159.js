function latest() {
    const card_title = "Kumulacja Energii";
    ...
    const card_description = `
        ...
        <p>
        Na początku każdej tury, jeżeli ta jednostka jest zajęta, przestaje być zajęta.
        </p>`;
    const card_flavor = `
        <i>
        "Muszę kumulować energię... Muszę kumulować energię... Muszę kumulować energię..."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/159.webp";
