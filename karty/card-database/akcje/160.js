function latest() {
    const card_title = "Układy";
    const site_title = card_title;
    const card_cost = "1C";
    const card_cost_info = "1 Moneta";
    const card_type = "Akcja - PLAN";
    const card_description = `
        <p>
        Adwansuj za każdym razem, gdy zagrasz kartę z kosztem zagrywania monet.
        </p>
        <p>
        1 - Zyskujesz 1 monetę. Dobierz 1 kartę.
        </p>
        <p>
        2 - Zyskujesz 2 monety. Zajmij wybraną wrogą jednostkę.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/160.webp";
