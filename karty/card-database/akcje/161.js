function latest() {
    ...
    const card_description = `
        ...
        <p>
        Za każdym razem, gdy ten wróg jest atakowany, traci on 2 zdrowia i gracz atakujący go zyskuje 5 zdrowia.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/161.webp";
