function latest() {
    const card_title = "Hochsztaplerska Zagrywka";
    ...
    const card_description = `
        <p>
        Każdy gracz odrzuca 1 kartę. Każdy gracz, który odrzucił kartę o największej sumie kosztów zagrywania, dobiera 1 kartę. Dobierz 1 kartę.
        </p>
        <p>
        Oddanie(Y): Każdy gracz odrzuca 1 kartę. Każdy gracz, który odrzucił kartę o największej sumie kosztów zagrywania, dobiera 1 kartę. Dobierz 1 kartę. Sprowokuj losową jednostkę wroga, który odrzucił kartę o najmniejszej sumie kosztów zagrywania.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/162.webp";
