function latest() {
    ...
    const card_description = `
        ...
        <p>
        Ulepsz tę jednostkę X razy, gdzie X jest liczbą różnych typów sojuszniczych jednostek. Przewiduj 1.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/163.webp";
