function latest() {
    const card_title = "Wszystko albo Nic";
    const site_title = card_title;
    const card_cost = "4C 5P";
    const card_cost_info = "4 Monety i 5 Popularności";
    const card_type = "Akcja";
    const card_description = `
        <p>
        Oddanie(YZ): Na początku każdej twojej tury możesz rzucić monetą:
        </p>
        <p>
        ORZEŁ - Podwój liczbę swoich monet.
        </p>
        <p>
        RESZKA - Tracisz wszystkie swoje monety.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/164.webp";
