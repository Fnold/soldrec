function latest() {
    const card_title = "Uścisk Null'a";
    const site_title = card_title;
    const card_cost = "5M 20P";
    const card_cost_info = "5 Many i 20 Popularności";
    ...
    const card_description = `
        ...
        <p>
        Jednostki o najwyższej sumie statystyk po każdej ze stron tracą -0/-0/-0/-5.
        </p>`;
    const card_flavor = `
        <i>
        Null istnieje w każdym wymiarze, w każdym świecie… Pokonasz go w jednym, a w każdym innym wciąż będzie istnieć.
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/165.webp";
