function latest() {
    const card_title = "Klątwa Omnibusa Liczenia";
    const site_title = card_title;
    const card_cost = "1J";
    const card_cost_info = "≥1 Wystawione Jednostki";
    const card_type = "Akcja";
    const card_description = `
        <p>
        Wszystkie instancje tracenia przez ciebie zdrowia dzieją się podwójnie.
        </p>`;
    const card_flavor = `
        <i>
        Gdy głupiec wytrwa w swoim głupstwie, stanie się mądry.
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/167.webp";
