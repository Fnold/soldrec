function latest() {
    const card_title = "Dzięki";
    const site_title = card_title;
    const card_cost = "3M 5P";
    const card_cost_info = "3 Many i 5 Popularności";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/168.webp";
