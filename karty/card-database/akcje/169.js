function latest() {
    ...
    const card_description = `
        <p>
        Zagrywane przez ciebie karty kosztują 1 mniej many.
        </p>
        <p>
        Oddanie(CN): Zagrywane przez ciebie karty kosztują 1 mniej many. Zagrywane przez wrogów karty kosztują 1 więcej many.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/169.webp";
