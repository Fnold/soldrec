function latest() {
    const card_title = "Wymaż";
    const site_title = card_title;
    const card_cost = "5C 10P";
    const card_cost_info = "5 Monet i 8 Popularności";
    ...
    const card_description = `
        ...
        <p>
        Ta karta zostaje wtasowana do talii jej oryginalnego włodarza.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/170.webp";
