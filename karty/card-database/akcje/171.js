function latest() {
    ...
    const card_description = `
        ...
        <p>
        Ta jednostka zyskuje ŻYWOTNOŚĆ 1.
        </p>`;
    const card_flavor = `
        <i>
        "Tak chcesz pogrywać? To nie ja ubrałem się w wielki nocnik by ukryć swoje słabości." - Korm do Skjiego Milo
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/171.webp";
