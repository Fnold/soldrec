function latest() {
    const card_title = "Palnik Facemeltera";
    ...
    const card_description = `
        ...
        <p>
        Ta jednostka zyskuje +X/+0/+0/+0, gdzie X jest wynikiem rzutu 2 kości D6.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/172.webp";
