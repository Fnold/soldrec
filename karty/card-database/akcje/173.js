function latest() {
    const card_title = "Fnoldrenalina";
    ...
    const card_description = `
        ...
        <p>
        Ta jednostka nie może umrzeć. Na początku twojej tury poświęć tę akcję i zatruj losowego wroga.
        </p>`;
    const card_flavor = `
        <i>
        "To będzie ostatnia deska ratunku, okej? Przez jakiś czas, zanim twoje nerki to przetrawią, będziesz odporny na JAKIEKOLWIEK obrażenia..." - Ludwig do Facemeltera
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/173.webp";
