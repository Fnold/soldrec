function latest() {
    ...
    const card_description = `
        ...
        <p>
        Ta jednostka zyskuje +3/+0/+0/+0. Ta jednostka nie może zostać oczyszczona. Każda instancja degradowania tej jednostki dzieje się podwójnie.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/174.webp";
