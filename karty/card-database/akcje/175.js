function latest() {
    const card_title = "Osobliwość";
    const site_title = card_title;
    const card_cost = "50P";
    const card_cost_info = "50 Popularności";
    ...
    const card_flavor = `
        <i>
        "GŁUPCZE, TO JEST PRADAWNA MOC ラ&NoBreak;ה&NoBreak;啊&NoBreak;बीਪ𓀽ขี!!!"
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/175.webp";
