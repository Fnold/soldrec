function latest() {
    const card_title = `Operacja "Operator"`;
    const site_title = card_title;
    const card_cost = "8M 17P";
    const card_cost_info = "8 Many i 17 Popularności";
    const card_type = "Akcja - NATYCH.";
    const card_description = `
        <p>
        Wybierz wrogiego operatora.
        </p>
        <p>
        Ta jednostka umiera.
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/176.webp";
