function latest() {
    const card_title = "Nowy Krenowin";
    const site_title = card_title;
    const card_cost = "3Z 10M";
    const card_cost_info = "3 Zdrowia i 10 Many";
    const card_type = "Akcja - PLAN";
    const card_description = `
        <p>
        Adwansuj za każdym razem, gdy zagrasz kartę, która nie jest twoim operatorem.
        </p>
        <p>
        1 - Dobierz 3 karty.
        </p>
        <p>
        2 - Zrzuć 3 karty. Tracisz 3 zdrowia.
        </p>
        <p>
        3 - Rzuć monetą:
        <br>
        ORZEŁ - Następna zagrana przez ciebie nie-szefowa jednostka w tej turze nie ma kosztów zagrywania.
        <br>
        RESZKA - Następna zagrana przez ciebie karta w tej turze ma podwojony koszt.
        </p>`;
    const card_flavor = `
        <i>
        Wybory wygrał oczywiście, w brawurowy sposób, Maciek Wios ze 100% poparciem.
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/177.webp";
