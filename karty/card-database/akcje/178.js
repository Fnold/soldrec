function latest() {
    ...
    const card_description = `
        ...
        <p>
        Jeżeli masz mniej niż połowę twojego maksymalnego zdrowia, ta karta zostaje usunięta z gry.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/178.webp";
