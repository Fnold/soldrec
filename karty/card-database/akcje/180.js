function latest() {
    const card_title = "Praca";
    const site_title = card_title;
    const card_cost = "4M 7P";
    const card_cost_info = "4 Many i 7 Popularności";
    const card_type = "Akcja - NATYCH.";
    const card_description = `
        <p>
        Wybierz X sojuszniczych niezajętych jednostek.
        </p>
        <p>
        ...
        <p>
        Oddanie(YZ): Zyskujesz 3*X monet.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/180.webp";
