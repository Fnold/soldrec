function latest() {
    const card_title = "Hold Ring";
    const site_title = card_title;
    const card_cost = "7M 11P";
    const card_cost_info = "7 Many i 11 Popularności";
    ...
    const card_description = `
        ...
        <p>
        Umieść tę jednostkę w ręce jej włodarza.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/181.webp";
