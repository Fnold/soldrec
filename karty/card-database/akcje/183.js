function latest() {
    ...
    const card_description = `
        ...
        <p>
        Oddanie(N): Dobierz 3 karty.
        </p>`;
    const card_flavor = `
        <i>
        Panem Nowego Krenowina jest Wios.
        <br>
        Każda rzecz jest częścią Wiosa.
        <br>
        Co roku odbywają się wybory na nowego Wiosa.
        <br>
        Każdy ma prawo do wolności myśli Wiosa i mowy Wiosa.
        <br>
        Wszyscy są równi wobec Wiosa.
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/183.webp";
