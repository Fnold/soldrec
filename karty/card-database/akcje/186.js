function latest() {
    const card_title = "Monumentalne Zadanie";
    const site_title = card_title;
    const card_cost = "20J 20M";
    const card_cost_info = "≥20 Wystawione Jednostki i 20 Many";
    const card_type = "Akcja";
    const card_description = `
        <p>
        Na początku każdej twojej tury, jeżeli masz wystawione 20 lub więcej jednostek, wygrywasz grę.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/186.webp";
