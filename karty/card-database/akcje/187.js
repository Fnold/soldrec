function latest() {
    const card_title = "Serwer Koparki";
    const site_title = card_title;
    const card_cost = "3M 8P";
    const card_cost_info = "3 Many i 8 Popularności";
    const card_type = "Akcja";
    const card_description = `
        <p>
        Na początku każdej twojej tury zyskujesz X monet, gdzie X jest liczbą sojuszniczych serwerów.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/187.webp";
