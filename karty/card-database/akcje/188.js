function latest() {
    ...
    const card_description = `
        <p>
        Domena Demonów: Za każdym razem, gdy twój wróg przegra grę, ulepsz każdą sojuszniczą jednostkę 13 razy.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/188.webp";
