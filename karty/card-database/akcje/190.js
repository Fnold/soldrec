function latest() {
    const card_title = "Zestaw Szpiegowski";
    const site_title = card_title;
    const card_cost = "3Z 6M";
    const card_cost_info = "3 Zdrowia i 6 Many";
    ...
    const card_description = `
        ...
        <p>
        Ta jednostka ma każdy typ jednostki.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/190.webp";
