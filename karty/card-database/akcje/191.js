function latest() {
    const card_title = "Klucz Pięćdziesięciu Wrót";
    const site_title = card_title;
    const card_cost = "5J 15P";
    const card_cost_info = "≥5 Wystawione Jednostki i 15 Popularności";
    ...
    const card_description = `
        ...
        <p>
        Pokaż górną kartę talii tego wroga. Możesz zagrać tę kartę bez kosztów zagrywania. Jeżeli to zrobisz, nadaj jej status UNICESTWIENIA i ten wróg zyskuje 5 zdrowia.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/191.webp";
