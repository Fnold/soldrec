function latest() {
    const card_title = "Ślub";
    const site_title = card_title;
    const card_cost = "2J 5M";
    const card_cost_info = "≥2 Wystawione Jednostki i 5 Many";
    ...
    const card_description = `
        ...
        <p>
        Ten wróg może dobrać 1 kartę. Jeżeli to zrobi, dobierz 2 karty.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/192.webp";
