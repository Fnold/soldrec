function latest() {
    const card_title = "Ku Uciesze Gawiedzi";
    const site_title = card_title;
    const card_cost = "3Z";
    const card_cost_info = "3 Zdrowia";
    const card_type = "Akcja";
    const card_description = `
        <p>
        Za każdym razem, gdy umiera jednostka, możesz zyskać 1 monetę i 1 zdrowia.
        </p>`;
    const card_flavor = `
        <i>
        Zanim powiesz mi, że robię to źle, może powiedz, co ty robisz poprawnie?
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/193.webp";
