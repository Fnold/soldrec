function latest() {
    ...
    const card_cost = "5Z";
    const card_cost_info = "5 Zdrowia";
    const card_type = "Akcja";
    const card_description = `
        <p>
        Pod koniec każdej twojej tury ulepsz jednostkę i dobierz 1 kartę.
        <br>
        Za każdym razem, gdy twój wróg zada ci obrażenia jednostką w walce, zmień stronę tej akcji na stronę tego wroga.
        </p>`;
    const card_flavor = `
        <i>
        Wycieki zdjęć z frontu nie napawały optymizmem. Żołnierze dostają listy od swoich bliskich. Cały świat widzi ich jako tych złych.
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/194.webp";
