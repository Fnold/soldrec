function latest() {
    const card_title = "Przepychanka";
    const site_title = card_title;
    const card_cost = "7M 13P";
    const card_cost_info = "7 Many i 13 Popularności";
    const card_type = "Akcja - NATYCH.";
    const card_description = `
        <p>
        Licytuj dobranie 3 kart o zdrowie. Zacznij od 0.
        </p>
        <p>
        Domena Bogaczy: Licytuj dobranie 5 kart o zdrowie. Zacznij od 0.
        </p>`;
    const card_flavor = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/197.webp";
