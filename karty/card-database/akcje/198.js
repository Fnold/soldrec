function latest() {
    const card_title = "Supremacja Suzila";
    ...
    const card_description = `
        <p>
        Każdy twój wróg odrzuca 1 kartę.
        </p>`;
    const card_flavor = `
        <i>
        "Zgodnie z doktryną Suzila - Każdy, nad kim nie ma się pełnej kontroli, jest potencjalnym wrogiem."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/198.webp";
