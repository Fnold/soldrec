function latest() {
    const card_title = "Lokata";
    const site_title = card_title;
    const card_cost = "10C 15P";
    const card_cost_info = "10 Monet i 15 Popularności";
    const card_type = "Akcja - PLAN";
    const card_description = `
        <p>
        Adwansuj na początku każdej twojej tury.
        </p>
        <p>
        1 - Zyskujesz 1 monetę.
        </p>
        <p>
        2 - Zyskujesz 3 monety.
        </p>
        <p>
        3 - Zyskujesz 6 monet.
        </p>
        <p>
        4 - Zyskujesz 10 monet.
        </p>`;
    const card_flavor = `
        <i>
        Pieniądze cię nie zmieniają. Pokazują jedynie kim naprawdę jesteś.
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/199.webp";
