function latest() {
    const card_title = "Zielony Płaszcz";
    ...
    const card_description = `
        ...
        <p>
        Ta jednostka zyskuje +0/&NoBreak;+0/&NoBreak;+0/&NoBreak;+X, gdzie X jest liczbą sojuszniczych zielonych jednostek.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/20.webp";
...
function alpha() {
    ...
    const card_description = `
        ...
        <p>
        Ta karta zyskuje +0/&NoBreak;+0/&NoBreak;+0/&NoBreak;+X gdzie X jest liczbą wystawionych zielonych sojuszniczych jednostek.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Soldik 2024
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/20.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
