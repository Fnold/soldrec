function latest() {
    const card_title = "Południowa Trumna";
    const site_title = card_title;
    const card_cost = "4J 4M";
    const card_cost_info = "≥4 Wystawione Jednostki i 4 Many";
    ...
    const card_description = `
        ...
        <p>
        Ustaw życie tej jednostki na bazowe.
        </p>
        <p>
        Oddanie(Z): Ustaw życie tej jednostki na bazowe. Jeżeli jest to jednostka sojusznicza, ulepsz ją 3 razy.
        </p>`;
    const card_flavor = `
        <i>
        Połacia terenu pokryte gęstymi lasami i niezbadanymi zakątkami stoją otworem.
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/203.webp";
