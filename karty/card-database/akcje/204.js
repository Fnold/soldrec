function latest() {
    const card_title = "Lakunarna Synestezja";
    const site_title = card_title;
    const card_cost = "25P";
    const card_cost_info = "25 Popularności";
    const card_type = "Akcja - NATYCH.";
    const card_description = `
        <p>
        Ustaw statystyki wszystkich jednostek na bazowe.
        </p>
        <p>
        Oddanie(Y): Ustaw statystyki wszystkich jednostek na bazowe. Ulepsz każdą sojuszniczą jednostkę 2 razy.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/204.webp";
