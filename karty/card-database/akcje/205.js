function latest() {
    const card_title = "Krwary Księżyc";
    ...
    const card_description = `
        <p>
        Wszystkie jednostki mają czerwoną kombinację kolorów.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/205.webp";
