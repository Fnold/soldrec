function latest() {
    const card_title = "Szafirowy Księżyc";
    const site_title = card_title;
    const card_cost = "3J 13P";
    const card_cost_info = "≥3 Wystawione Jednostki i 13 Popularności";
    const card_type = "Akcja";
    const card_description = `
        <p>
        Wszystkie jednostki mają niebieską kombinację kolorów.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/206.webp";
