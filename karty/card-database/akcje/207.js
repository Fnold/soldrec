function latest() {
    const card_title = "Bursztynowy Księżyc";
    ...
    const card_description = `
        <p>
        Wszystkie jednostki mają żółtą kombinację kolorów.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/207.webp";
