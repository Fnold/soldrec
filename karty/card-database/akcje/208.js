function latest() {
    const card_title = "Szmaragdowy Księżyc";
    ...
    const card_description = `
        <p>
        Wszystkie jednostki mają zieloną kombinację kolorów.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/208.webp";
