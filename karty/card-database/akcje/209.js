function latest() {
    const card_title = "Nieforsownia";
    const site_title = card_title;
    const card_cost = "20M 16P";
    const card_cost_info = "20 Many i 16 Popularności";
    ...
    const card_description = `
        ...
        <p>
        Ten wróg rozdziela swoje jednostki na dwa stosy. Wybrany przez ciebie stos trafia na cmentarz tego wroga.
        </p>`;
    const card_flavor = `
        <i>
        "Czym się różni twój los od mojego? Zapewne miałeś plan, by dzisiaj ją powitać jak codzień. Ona miała tobie powiedzieć do ucha jak bardzo ciebie kocha. Zapewne czuła się przy tobie bezpiecznie. Kochałeś ją i planowaliście wspólnie waszą przyszłość... dopóki nie przyszedłem i wam tego nie odebrałem."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/209.webp";
