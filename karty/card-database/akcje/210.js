function latest() {
    const card_title = "Wejdź w Multiwersum";
    const site_title = card_title;
    const card_cost = "10Z 20M";
    const card_cost_info = "10 Zdrowia i 20 Many";
    const card_type = "Akcja - NATYCH.";
    const card_description = `
        <p>
        Zyskujesz X zdrowia, gdzie X jest liczbą pozostałych kart w twojej talii.
        </p>`;
    const card_flavor = `
        <i>
        "Możecie uciekać... To tylko opóźni nieuniknione."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/210.webp";
