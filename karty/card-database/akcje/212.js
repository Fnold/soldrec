function latest() {
    const card_title = "Obżarstwo";
    const site_title = card_title;
    const card_cost = "6M 13P";
    const card_cost_info = "6 Many i 13 Popularności";
    const card_type = "Akcja";
    const card_description = `
        <p>
        Na początku tury każdego gracza ten gracz dobiera dodatkowo 1 kartę.
        </p>
        <p>
        Za każdym razem, gdy twój wróg dobierze kartę, ten wróg traci 1 zdrowia.
        </p>`;
    const card_flavor = `
        <i>
        Siłą jest to, że możesz zrobić wszystko. Słabością jest to, że to zrobisz.
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/212.webp";
