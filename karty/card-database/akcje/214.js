function latest() {
    const card_title = "Potyczka";
    const site_title = card_title;
    const card_cost = "12M 20P";
    const card_cost_info = "12 Many i 20 Popularności";
    const card_type = "Akcja - NATYCH.";
    const card_description = `
        <p>
        Wybierz dwie jednostki po różnych stronach.
        </p>
        <p>
        Przeprowadź starcie między tymi jednostkami.
        </p>
        <p>
        Oddanie(C): Przeprowadź starcie między tymi jednostkami. Przegrany traci 10 zdrowia.
        </p>`;
    const card_flavor = `
        <i>
        Chwilę tak walczą. Ignis tańczy jak on gra. Odpowiada na jego każdy atak. Jednakże, stare sztuczki na niego już nie działają.
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/214.webp";
