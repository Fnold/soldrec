function latest() {
    const card_title = "Rewitalizujące Pole";
    ...
    const card_description = `
        <p>
        Za każdym razem, gdy zagrywasz jednostkę, ulecz się o 2.
        </p>
        <p>
        Oddanie(Z): Za każdym razem, gdy zagrywasz jednostkę, ulecz się o 4.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/22.webp";
...
function alpha() {
    ...
    const card_description = `
        <p>
        Za każdym razem gdy zagrywasz jednostkę to ulecz się o 2.
        </p>
        <p>
        Oddanie(Z): Za każdym razem gdy zagrywasz jednostkę to ulecz się o 4.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Soldik 2024
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/22.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
