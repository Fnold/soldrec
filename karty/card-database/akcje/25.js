function latest() {
    const card_title = "Z Wiatrem";
    const site_title = card_title;
    const card_cost = "20P";
    const card_cost_info = "20 Popularności";
    const card_type = "Akcja - NATYCH.";
    const card_description = `
        <p>
        Twoja następna akcja z tempem ROZKAZ bez ładunków ma tempo NATYCH.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/25.webp";
...
function alpha() {
    ...
    const card_description = `
        <p>
        Twoja następna zagrana akcja ma tempo NATYCH.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Soldin 2024
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/25.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
