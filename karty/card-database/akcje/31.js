function latest() {
    const card_title = "Deszcz Strzał";
    ...
    const card_description = `
        <p>
        Wszystkie wystawione jednostki tracą -0/&NoBreak;-0/&NoBreak;-0/&NoBreak;-1.
        </p>
        <p>
        Oddanie(C): Wszystkie wrogie jednostki tracą -0/&NoBreak;-0/&NoBreak;-0/&NoBreak;-2.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/31.webp";
...
function v1_1_0() {
    const card_title = "Kwaśny Deszcz";
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/1.1.0/akcje/31.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_1_0_selector").innerHTML = `&gt;<u>v1.1.0</u>`;
    document.getElementById("alpha_selector").innerHTML = `<u>Alpha</u>`;
...
function alpha() {
    ...
    const card_description = `
        ...
        <p>
        Oddanie(C): Wszystkie wystawione wrogie jednostki tracą -0/&NoBreak;-0/&NoBreak;-0/&NoBreak;-2.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/31.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_1_0_selector").innerHTML = `<u>v1.1.0</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
