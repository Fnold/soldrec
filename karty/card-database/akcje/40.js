function latest() {
    const card_title = "Eliksir Wigoru";
    ...
    const card_description = `
        ...
        <p>
        Za każdym razem, gdy ta jednostka zostaje zablokowana przez zatrutą jednostkę, blokująca jednostka umiera. Za każdym razem, gdy ta jednostka atakuje, a jej sąsiedzi nie, ta jednostka zyskuje +5/&NoBreak;+0/&NoBreak;+0/&NoBreak;+0 do końca tury.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/40.webp";
...
function v1_1_0() {
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/1.1.0/akcje/40.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_1_0_selector").innerHTML = `&gt;<u>v1.1.0</u>`;
    document.getElementById("alpha_selector").innerHTML = `<u>Alpha</u>`;
...
function alpha() {
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/40.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_1_0_selector").innerHTML = `<u>v1.1.0</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
