function latest() {
    ...
    const card_description = `
        <p>
        Twoi wrogowie mogą zagrywać maksymalnie 1 akcję na turę.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/41.webp";
...
function alpha() {
    ...
    const card_description = `
        <p>
        Twój wróg może zagrywać maksymalnie 1 akcję na turę.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Soldik 2024
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/41.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
