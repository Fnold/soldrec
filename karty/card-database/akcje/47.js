function latest() {
    ...
    const card_description = `
        <p>
        Pod koniec każdej twojej tury, w której zyskałeś/aś 4 lub więcej zdrowia, dobierasz 1 kartę.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/47.webp";
...
function v1_1_0() {
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/1.1.0/akcje/47.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_1_0_selector").innerHTML = `&gt;<u>v1.1.0</u>`;
    document.getElementById("alpha_selector").innerHTML = `<u>Alpha</u>`;
...
function alpha() {
    ...
    const card_description = `
        <p>
        Pod koniec każdej twojej tury w której uleczyłeś/aś się o 4 lub więcej zdrowia dobierasz kartę ze swojej talii.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: -
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/47.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_1_0_selector").innerHTML = `<u>v1.1.0</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
