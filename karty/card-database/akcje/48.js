function latest() {
    ...
    const card_description = `
        <p>
        Za każdym razem, gdy twoje zdrowie spadnie poniżej 1 w walce, zamiast tego spada ono do 1.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/48.webp";
...
function v1_1_0() {
    ...
    const card_description = `
        <p>
        Zwiększ swoje maksymalne zdrowie o 100. Możesz otrzymać śmiertelny cios tylko gdy brakuje ci 1 zdrowia do przegranej.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Fnold 2023
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/1.1.0/akcje/48.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_1_0_selector").innerHTML = `&gt;<u>v1.1.0</u>`;
    document.getElementById("alpha_selector").innerHTML = `<u>Alpha</u>`;
...
function alpha() {
    ...
    const card_description = `
        <p>
        Możesz dostać śmiertelny cios tylko gdy brakuje ci 1 zdrowia do przegranej. Twoje maksymalne zdrowie wynosi 200.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Fnold 2023
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/48.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_1_0_selector").innerHTML = `<u>v1.1.0</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
