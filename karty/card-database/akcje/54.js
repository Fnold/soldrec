function latest() {
    const card_title = "Obrażenia Niebezpośrednie";
    ...
    const card_description = `
        <p>
        Za każdym razem, gdy ginie sojusznicza jednostka, każdy twój wróg poświęca jednostkę.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/54.webp";
...
function alpha() {
    ...
    const card_description = `
        <p>
        Za każdym razem gdy ginie sojusznicza jednostka to twój wróg poświęca jednostkę.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/54.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
