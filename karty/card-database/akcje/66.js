function latest() {
    const card_title = "Dokładanie do Pieca";
    ...
    const card_description = `
        <p>
        Wybierz kolor jednostki.
        </p>
        <p>
        Za każdym razem, gdy zagrasz jednostkę z tym kolorem, połóż licznik na tej akcji i ulepsz tę jednostkę 2*X razy, gdzie X jest liczbą liczników na tej akcji.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/66.webp";
...
function v1_1_0() {
    ...
    const card_description = `
        ...
        <p>
        Za każdym razem, gdy zagrywasz jednostkę z tym kolorem, połóż licznik na tej akcji i ulepsz tę jednostkę 2*X razy, gdzie X jest liczbą liczników na tej akcji.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Fnold 2023
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/1.1.0/akcje/66.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_1_0_selector").innerHTML = `&gt;<u>v1.1.0</u>`;
    document.getElementById("alpha_selector").innerHTML = `<u>Alpha</u>`;
...
function alpha() {
    ...
    const card_description = `
        ...
        <p>
        Za każdym razem gdy zagrywasz jednostkę z wybranym wcześniej kolorem to połóż licznik na tej karcie i ulepsz tę jednostkę 2*X razy gdzie X jest liczbą liczników na tej karcie.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Fnold 2023
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/66.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_1_0_selector").innerHTML = `<u>v1.1.0</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
