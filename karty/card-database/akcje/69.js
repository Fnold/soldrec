function latest() {
    ...
    const card_description = `
        <p>
        Pokaż 5 górnych kart z twojej talii i rozdziel je na dwa stosy. Wybrany wróg decyduje, który stos trafi do twojej ręki, a który na twój cmentarz.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/69.webp";
...
function alpha() {
    ...
    const card_description = `
        <p>
        Pokaż 5 górnych kart z twojej talii i rozdziel je na dwa stosy. Twój wróg wybiera który stos trafi do twojej ręki a który na twój cmentarz.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Fnold 2023
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/69.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
