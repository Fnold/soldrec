function latest() {
    ...
    const card_description = `
        ...
        <p>
        Za każdym razem, gdy ta jednostka blokuje atak, jednostka zablokowana ginie.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/8.webp";
...
function alpha() {
    ...
    const card_description = `
        ...
        <p>
        Gdy ta jednostka zostanie zaatakowana przez inną jednostkę to nadawca ataku umiera. (Obrażenia nadal się zadają)
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Fnold 2023
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/8.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
