function latest() {
    ...
    const card_description = `
        <p>
        Za każdym razem, gdy dobierasz kartę, zyskujesz 1 monetę.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/85.webp";
...
function alpha() {
    ...
    const card_description = `
        <p>
        Za każdą jedną twoją dobraną kartę zyskujesz 1 monetę.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Soldik 2023
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/85.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
