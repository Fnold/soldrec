function latest() {
    const card_title = "Napaść Piratów";
    ...
    const card_description = `
        ...
        <p>
        Ten wróg traci 2 zdrowia i poświęca losową wystawioną akcję.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/89.webp";
...
function alpha() {
    ...
    const card_description = `
        <p>
        Twój wróg poświęca losową wystawioną akcję.
        </p>`;
    const card_author = `
        <i>
        Ilustracja: Soldik 2020
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/89.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
