function latest() {
    const card_title = "Karykatura";
    const site_title = card_title;
    const card_cost = "1M 8P";
    const card_cost_info = "1 Many i 8 Popularności";
    const card_type = "Akcja - NATYCH.";
    const card_description = `
        <p>
        Wybierz losową wrogą jednostkę.
        </p>
        <p>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/akcje/99.webp";
...
function alpha() {
    ...
    document.getElementById("card_description").innerHTML = card_description;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/akcje/99.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
