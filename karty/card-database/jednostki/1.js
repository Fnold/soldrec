function latest() {
    const card_title = "Pogromca UT";
    const site_title = card_title;
    const card_cost = "6M 4P";
    const card_cost_info = "6 Many i 4 Popularności";
    const card_type = "Jednostka";
    const card_subtype = `
        <p>
        Człowiek, Bogacz, Niszczyciel, Mag
        </p>`;
    const card_stats = `
        <p>
        5/3/1/4
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/1.webp";
