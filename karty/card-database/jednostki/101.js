function latest() {
    const card_title = "Mavehammer";
    const site_title = card_title;
    const card_cost = "12M 7P";
    const card_cost_info = "12 Many i 7 Popularności";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/101.webp";
