function latest() {
    const card_title = "Korm";
    const site_title = card_title;
    const card_cost = "4Z 11M";
    const card_cost_info = "4 Zdrowia i 11 Many";
    ...
    const card_description = `
        <p>Wybierz wrogą jednostkę lub gracza. Ta jednostka lub gracz zostaje zatruta.</p>
        <br>
        <p>Pod koniec każdej twojej tury każdy twój wróg degraduje każdą jednostkę, której jest włodarzem.</p>`;
    const card_stats = `
        <p>
        7/0/0/3
        </p>`;
    const card_flavor = `
        <i>
        "Pytasz się czemu nadal to robię mimo, że nigdy go nie pokonam? Przestań zadawać pytania i spróbuj ponownie!"
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/107.webp";
