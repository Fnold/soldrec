function latest() {
    const card_title = "Jankowski";
    const site_title = card_title;
    const card_cost = "5Z 5C 5M";
    const card_cost_info = "5 Zdrowia, 5 Monet i 5 Many";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/108.webp";
