function latest() {
    const card_title = "Chmielnik";
    const site_title = card_title;
    const card_cost = "4Z 8P";
    const card_cost_info = "4 Zdrowia i 8 Popularności";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/110.webp";
