function latest() {
    const card_title = "Pigh";
    const site_title = card_title;
    const card_cost = "10M 5P";
    const card_cost_info = "10 Many i 5 Popularności";
    ...
    const card_flavor = `
        <i>
        "Jestem Pigh. Dla przyjaciół - Agent Pigh. A dla was tylko Pigh."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/111.webp";
