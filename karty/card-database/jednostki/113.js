function latest() {
    const card_title = "Gazeciarz";
    const site_title = card_title;
    const card_cost = "3Z 13M 5P";
    const card_cost_info = "3 Zdrowia, 13 Many i 5 Popularności";
    const card_type = "Jednostka";
    const card_subtype = `
        <p>
        Człowiek, Nieumarły, Kler
        </p>`;
    const card_stats = `
        <p>
        0/10/10/3
    ...
    const card_flavor = `
        <i>
        "Świat jest jak piłka. Mogę go gnieść, starać się zmienić jej kształt, ale za każdym razem wraca do pierwotnego kulistego kształtu. Jeżeli zacznę w nią stukać, na niej skakać, tulić ją tak bardzo, że pęknie, wtedy stanie się czymś innym, ale wielcy oddani fani kulistości na mnie nakrzyczą. Nie będą przecież mogli już kopać piłki nieokrągłej." 
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/113.webp";
