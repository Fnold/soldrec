function latest() {
    const card_title = "Dziadek Półn. Lipinu";
    const site_title = card_title;
    const card_cost = "2J 4M 6P";
    const card_cost_info = "≥2 Wystawione Jednostki, 4 Many i 6 Popularności";
    const card_type = "Jednostka - Operator z Gwiazdką";
    const card_subtype = `
        <p>
        Szef, Człowiek, Nieumarły, Kler
        </p>`;
    const card_description = `
        <p>Wybierz wroga. Ten wróg zyskuje X zdrowia, gdzie X jest liczbą liczników na kartach, których jesteś włodarzem.</p>
        <br>
        <p>Pod koniec każdej twojej tury ty oraz twój wróg z najmniejszą liczbą kart w ręce dobieracie 1 kartę. Jeżeli nie ma pojedynczego wroga z najmniejszą liczbą kart w ręce to zamiast tego ulecz się o 5 i każdy gracz dobiera 1 kartę.</p>`;
    const card_stats = `
        <p>
        0/2/2/2
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/114.webp";
