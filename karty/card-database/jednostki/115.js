function latest() {
    const card_title = "Pomidorowy Inżynier";
    const site_title = card_title;
    const card_cost = "3J 1M";
    const card_cost_info = "≥3 Wystawione Jednostki i 1 Many";
    ...
    const card_flavor = `
        <i>
        "Powstań, mój Robocie! Musisz zniszczyć Rycerza 1, bo inaczej on zabije nas wszystkich!"
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/115.webp";
