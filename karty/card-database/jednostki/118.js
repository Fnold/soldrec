function latest() {
    const card_title = "Dzieciak";
    const site_title = card_title;
    const card_cost = "5Z 10M";
    const card_cost_info = "5 Zdrowia i 10 Many";
    ...
    const card_description = `
        <p>Ta jednostka zyskuje ŻYWOTNOŚĆ 1.</p>
        <br>
        <p>Za każdym razem, gdy ta jednostka przeżyje jej zablokowany atak lub akcję zmniejszającą jej życie, ta jednostka zyskuje +X/+0/+0/+0, gdzie X jest pozostałym życiem po ataku.</p>`;
    const card_stats = `
        <p>
        5/1/3/5
        </p>`;
    const card_flavor = `
        <i>
        "Mówię w imieniu wszystkich, których nienawidzisz, wszystkich, których kiedykolwiek skrzywdziłeś..." - Dzieciak do Facemeltera
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/118.webp";
