function latest() {
    const card_title = "Yagami";
    const site_title = card_title;
    const card_cost = "3J 16M";
    const card_cost_info = "≥3 Wystawione Jednostki i 16 Many";
    const card_type = "Jednostka - Operator bez Gwiazdki";
    const card_subtype = `
        <p>
        Człowiek, Bestia, Nieumarły, Niszczyciel
        </p>`;
    const card_description = `
        <p>Ulepsz tę jednostkę 2 razy.</p>
        <br>
        <p>Ta jednostka nie może umrzeć.</p>`;
    const card_stats = `
        <p>
        5/1/3/5
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/119.webp";
