function latest() {
    const card_title = "Jelena";
    const site_title = card_title;
    const card_cost = "16M 13P";
    const card_cost_info = "16 Many i 13 Popularności";
    ...
    const card_description = `
        <p>Wybierz wroga. Do końca tej tury wasze zdrowia są zamienione</p>
        <br>
        <p>Za każdym razem, gdy twój wróg cię wybierze, możesz stracić 10 zdrowia lub dobrać 1 kartę.</p>`;
    const card_stats = `
        <p>
        3/3/3/2
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/120.webp";
