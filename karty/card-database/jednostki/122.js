function latest() {
    const card_title = "Kultysta";
    const site_title = card_title;
    const card_cost = "7J";
    const card_cost_info = "≥7 Wystawione Jednostki";
    const card_type = "Jednostka";
    const card_subtype = `
        <p>
        Człowiek, Demon, Niszczyciel, Mag
        </p>`;
    const card_stats = `
        <p>
        10/10/5/3
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/122.webp";
