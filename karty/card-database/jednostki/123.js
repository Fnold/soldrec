function latest() {
    ...
    const card_description = `
        <p>Zrzuć 2 karty.</p>
        <br>
        <p>Za każdym razem, gdy karta trafia na cmentarz z twojej talii, zamiast tego dobierz 1 kartę i odrzuć 1 kartę.</p>`;
    const card_stats = `
        <p>
        2/3/2/2
        </p>`;
    const card_flavor = `
        <i>
        "Nazywam się Zuzia, drodzy Państwo. Jestem kotką."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/123.webp";
