function latest() {
    const card_title = "Pałac";
    const site_title = card_title;
    const card_cost = "2M 2P";
    const card_cost_info = "2 Many i 2 Popularności";
    ...
    const card_flavor = `
        <i>
        "W centrum miasta ulokowany jest wielki lodowy pałac. Jest podobno tak czysty, że można się w nim przejrzeć. Bardzo przypomina kryształowy pałac, który to znajduje się w Cesarstwie. Architekci obu budowli nigdy się nie poznali. Czysty przypadek."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/124.webp";
