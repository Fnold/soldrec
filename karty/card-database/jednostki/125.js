function latest() {
    ...
    const card_description = `
        <p>Każdy gracz dobiera 1 kartę.</p>
        <br>
        <p>Za każdym razem, gdy twój wróg próbuje dobrać kartę z pustej talii, ten wróg przegrywa grę.</p>`;
    const card_stats = `
        <p>
        5/6/6/4
        </p>`;
    const card_flavor = `
        <i>
        "Ja tylko chcę z powrotem zobaczyć moją córeczkę..."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/125.webp";
