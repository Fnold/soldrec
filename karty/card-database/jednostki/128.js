function latest() {
    const card_title = "Franklin";
    const site_title = card_title;
    const card_cost = "1Z 15M 15P";
    const card_cost_info = "1 Zdrowia, 15 Many i 15 Popularności";
    const card_type = "Jednostka - Operator z Gwiazdką";
    const card_subtype = `
        <p>
        Szef, Bestia, Niszczyciel
        </p>`;
    const card_description = `
        <p>Zapłać koszt zagrywania wybranej karty z twojej ręki, pokaż ją i usuń ją z gry.</p>
        <br>
        <p>Skopiuj i zagraj wszystkie karty usunięte z gry za pomocą tej jednostki w kolejności od najstarszej do najnowszej. Te karty zyskują status UNICESTWIENIA.</p>
        <br>
        <p>Za każdym razem, gdy ta jednostka zostaje zajęta, tracisz 4 zdrowia. Pod koniec każdej twojej tury odrzuć 1 kartę.</p>`;
    const card_stats = `
        <p>
        1/1/5/1
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/128.webp";
