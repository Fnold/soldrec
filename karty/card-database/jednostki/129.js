function latest() {
    ...
    const card_description = `
        <p>Przewiduj 2.</p>
        <br>
        <p>Gracze nie mają limitu zdrowia. Na początku każdej sojuszniczej tury zyskujesz 1 zdrowia.</p>`;
    const card_stats = `
        <p>
        2/8/5/10
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/129.webp";
