function latest() {
    const card_title = "Golem";
    const site_title = card_title;
    const card_cost = "3C";
    const card_cost_info = "3 Monety";
    ...
    const card_flavor = `
        <i>
        "Brać go" - Rycerz 1 podczas spotkania z Golemem
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/132.webp";
