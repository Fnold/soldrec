function latest() {
    const card_title = "Irczysław Kositrawa";
    const site_title = card_title;
    const card_cost = "15M 15P";
    const card_cost_info = "15 Many i 15 Popularności";
    ...
    const card_description = `
        <p>Wybierz wrogą jednostkę. Ta jednostka zostaje zajęta.</p>
        <br>
        <p>Za każdym razem, gdy ta jednostka atakuje, zyskuje ona +X/+0/+0/+0 i KRWAWIENIE X, gdzie X jest liczbą jednostek po stronie gracza broniącego. Za każdym razem, gdy umiera wroga jednostka, ta jednostka zostaje oczyszczona.</p>`;
    const card_stats = `
        <p>
        7/2/6/7
        </p>`;
    const card_flavor = `
        <i>
        Legendarny obrońca dobra, potrafiący zmieść całe armie tylko przy strzyknięciu palcami.
        </i>`;
    const card_author = `
        <i>
        Ilustracja: Krafcik 2022
        </i>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/136.webp";
