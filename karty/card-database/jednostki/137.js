function latest() {
    const card_title = "Ludwig";
    const site_title = card_title;
    const card_cost = "30P";
    const card_cost_info = "30 Popularności";
    ...
    const card_description = `
        <p>Ulepsz sojuszniczą jednostkę inną niż ta.</p>
        <br>
        <p>Zagrywane przez ciebie akcje kosztują o X mniej many, gdzie X jest liczbą sojuszniczych jednostek, których każda ze statystyk różni się od bazowej.</p>`;
    const card_stats = `
        <p>
        3/5/4/5
        </p>`;
    const card_flavor = `
        <i>
       "To koniec, Facemelter! Stworzyłem drużynę aby stawić ci czoło! Poddaj się!"
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/137.webp";
