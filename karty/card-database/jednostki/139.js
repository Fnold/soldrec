function latest() {
    const card_title = "Ignis";
    const site_title = card_title;
    const card_cost = "1Z 20M";
    const card_cost_info = "1 Zdrowia i 20 Many";
    const card_type = "Jednostka - Operator bez Gwiazdki";
    const card_subtype = `
        <p>
        Człowiek, Demon, Przyroda, Mag
        </p>`;
    const card_description = `
        <p>Wybierz wroga. Połóż licznik na tej karcie. Ten wróg traci X zdrowia, gdzie X jest liczbą liczników na tej karcie.</p>
        <br>
        <p>Za każdym razem, gdy karta zostanie usunięta z gry, ta jednostka zyskuje +1/&NoBreak;+0/&NoBreak;+0/&NoBreak;+0.</p>`;
    const card_stats = `
        <p>
        8/5/8/6
        </p>`;
    const card_flavor = `
        <i>
       "Wygląda jak Mary, tylko niska i... wesoła?"
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/139.webp";
