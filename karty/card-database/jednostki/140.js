function latest() {
    const card_title = "Bebech";
    const site_title = card_title;
    const card_cost = "1C 5P";
    const card_cost_info = "1 Moneta i 5 Popularności";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/140.webp";
