function latest() {
    const card_title = "Samanta";
    const site_title = card_title;
    const card_cost = "12M 2P";
    const card_cost_info = "12 Many i 2 Popularności";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/141.webp";
