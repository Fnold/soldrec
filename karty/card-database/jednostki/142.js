function latest() {
    const card_title = "Facemelter";
    const site_title = card_title;
    const card_cost = "20M";
    const card_cost_info = "20 Many";
    ...
    const card_description = `
        <p>Wybierz akcję akceptującą ładunki. Ta akcja zyskuje X ładunków, gdzie X jest liczbą liczników na tej jednostce.</p>
        <br>
        <p>Za każdym razem, gdy inteligencja tej jednostki staje się wielokrotnością liczby 10, połóż licznik na tej jednostce. Liczniki pozostają na tej jednostce, nawet gdy przestaje być wystawiona.</p>`;
    const card_stats = `
        <p>
        5/8/8/8
        </p>`;
    const card_flavor = `
        <i>
       "Zrobiłem to, co należało zrobić... Zakończyłem cierpienie każdego..."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/142.webp";
