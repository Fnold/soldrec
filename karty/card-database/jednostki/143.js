function latest() {
    const card_title = "Greg";
    const site_title = card_title;
    const card_cost = "2J 12M 12P";
    const card_cost_info = "≥2 Wystawione Jednostki, 12 Many i 12 Popularności";
    ...
    const card_description = `
        <p>Nasyć wybraną sojuszniczą jednostkę inną niż ta: "Na początku twojej tury dobierasz dodatkowo 1 kartę."</p>
        <br>
        <p>Zagrywane przez ciebie akcje z tempem ROZKAZ z ładunkami mają 1 dodatkowy ładunek. Zagrywane przez ciebie akcje z tempem ROZKAZ bez ładunków mają tempo NATYCH.</p>`;
    const card_stats = `
        <p>
        2/6/4/4
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/143.webp";
