function latest() {
    const card_title = "Uzbek";
    const site_title = card_title;
    const card_cost = "15M 12P";
    const card_cost_info = "15 Many i 12 Popularności";
    const card_type = "Jednostka - Operator bez Gwiazdki";
    const card_subtype = `
        <p>
        Przyroda, Bestia, Niszczyciel, Mag
        </p>`;
    const card_description = `
        <p>Wybierz niewybraną jednostkę z bazowymi statystykami. Ta jednostka umiera.</p>
        <br>
        <p>Za każdym razem, gdy ta jednostka atakuje wroga i po jej ataku ma on 8 lub mniej zdrowia, ten wróg przegrywa grę.</p>
        <p>Oddanie(C): Za każdym razem, gdy ta jednostka atakuje wroga i po jej ataku ma on 10 lub mniej zdrowia, ten wróg przegrywa grę.</p>`;
    const card_stats = `
        <p>
        7/3/7/5
        </p>`;
    const card_flavor = `
        <i>
        Zna wszystkie sztuki walki świata i o 3 więcej.
        </i>`;
    const card_author = `
        <i>
        Ilustracja: Krafcik 2021
        </i>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/144.webp";
