function latest() {
    const card_title = "Xopin";
    const site_title = card_title;
    const card_cost = "10Z";
    const card_cost_info = "10 Zdrowia";
    const card_type = "Jednostka - Operator z Gwiazdką";
    const card_subtype = `
        <p>
        Szef, Człowiek, Nieumarły, Niszczyciel
        </p>`;
    const card_description = `
        <p>Każdy gracz zrzuca 1 kartę.</p>
        <br>
        <p>Pod koniec każdej twojej tury, zmień stronę tej jednostki na gracza po twojej prawej i podwój jej statystyki. Następnie ten gracz traci X zdrowia, gdzie X jest wartością największej statystyki tej jednostki.</p>`;
    const card_stats = `
        <p>
        1/0/1/1
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/145.webp";
