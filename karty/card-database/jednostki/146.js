function latest() {
    const card_title = "Shiroktu";
    const site_title = card_title;
    const card_cost = "16M 7P";
    const card_cost_info = "16 Many i 7 Popularności";
    ...
    const card_flavor = `
        <i>
        "W rozświetlonej jaskini Milo był pewny co ujrzał. To był wielki jaszczur ze skrzydłami. Zrodzony z białych łusek. Posiadał wielkie kły jego wielkości. Czuł się przy nim jak chłopiec z wykałaczką." - Spotkanie Milo z Shiroktu
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/146.webp";
