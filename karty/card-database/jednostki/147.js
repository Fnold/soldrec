function latest() {
    const card_title = "Astro Gofer";
    const site_title = card_title;
    const card_cost = "2J 14M";
    const card_cost_info = "≥2 Wystawione Jednostki i 14 Many";
    ...
    const card_flavor = `
        <i>
        "Ten kupuje KILOGRAMY tego popcornu."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/147.webp";
