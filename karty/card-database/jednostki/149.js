function latest() {
    const card_title = "Żółw Terrorysta";
    const site_title = card_title;
    const card_cost = "20M 5P";
    const card_cost_info = "20 Many i 5 Popularności";
    const card_type = "Jednostka - Operator Szarak";
    const card_subtype = `
        <p>
        Szarak, Bestia, Niszczyciel
        </p>`;
    const card_description = `
        <p>
        Wybierz gracza. Ten gracz traci 10 zdrowia.
        </p>`;
    const card_stats = `
        <p>
        10/3/4/6
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/149.webp";
