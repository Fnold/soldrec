function latest() {
    const card_title = "Armia Trójkątów";
    const site_title = card_title;
    const card_cost = "15M 20P";
    const card_cost_info = "15 Many i 20 Popularności";
    ...
    const card_description = `
        <p>
        Wybierz gracza. Ten gracz zyskuje 10 zdrowia.
        </p>`;
    const card_stats = `
        <p>
        2/3/4/9
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/150.webp";
