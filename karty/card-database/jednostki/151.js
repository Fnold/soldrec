function latest() {
    const card_title = "Anfidin";
    const site_title = card_title;
    const card_cost = "1Z 3J 5M 11P";
    const card_cost_info = "1 Zdrowia, ≥3 Wystawione Jednostki, 5 Many i 11 Popularności";
    const card_type = "Jednostka - Operator Szarak";
    const card_subtype = `
        <p>
        Szarak, Człowiek, Morska
        </p>`;
    const card_description = `
        <p>
        W fazie ulepszania ulepsz tę jednostkę X razy. Zagrywane przez ciebie karty kosztują X mniej many, gdzie X jest liczbą sojuszniczych jednostek, których inteligencja wynosi 0.
        </p>`;
    const card_stats = `
        <p>
        2/6/3/6
    ...
    const card_flavor = `
        <p>
        "Niech to prawo będzie świętym gwarantem porządku i przetrwania."
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/151.webp";
