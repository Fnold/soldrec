function latest() {
    const card_title = "Demian";
    const site_title = card_title;
    const card_cost = "1M 11P";
    const card_cost_info = "1 Many i 11 Popularności";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/153.webp";
