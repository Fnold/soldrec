function latest() {
    const card_title = "Paser";
    const site_title = card_title;
    const card_cost = "11M 11P";
    const card_cost_info = "11 Many i 11 Popularności";
    const card_type = "Jednostka - Operator Szarak";
    const card_subtype = `
        <p>
        Szarak, Człowiek, Bogacz
        </p>`;
    const card_description = `
        <p>
        Odrzuć 1 kartę i dobierz 1 kartę.
        </p>`;
    const card_stats = `
        <p>
        5/5/4/3
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/154.webp";
