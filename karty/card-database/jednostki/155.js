function latest() {
    const card_title = "Znojniak";
    const site_title = card_title;
    const card_cost = "32P";
    const card_cost_info = "32 Popularności";
    const card_type = "Jednostka - Operator Szarak";
    const card_subtype = `
        <p>
        Szarak, Maszyna, Niszczyciel
        </p>`;
    const card_description = `
        <p>
        Tyle, ile ta jednostka zadaje wrogowi obrażeń w walce, tyle ten wróg zrzuca kart.
        </p>`;
    const card_stats = `
        <p>
        8/0/7/5
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/155.webp";
