function latest() {
    ...
    const card_description = `
        <p>
        Gdy ta jednostka jest wystawiona lub zagrywana, ma ona wszystkie typy jednostki.
        </p>`;
    const card_stats = `
        <p>
        4/4/4/4
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/157.webp";
