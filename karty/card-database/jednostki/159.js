function latest() {
    const card_title = "Void";
    const site_title = card_title;
    const card_cost = "17M 7P";
    const card_cost_info = "17 Many i 7 Popularności";
    ...
    const card_description = `
        <p>Wybierz wroga. Ten wróg poświęca akcję.</p>
        <br>
        <p>Za każdym razem, gdy twój wróg przegrywa grę, ta jednostka zyskuje +13/&NoBreak;+13/&NoBreak;+13/&NoBreak;+13.</p>`;
    const card_stats = `
        <p>
        6/5/6/5
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/159.webp";
