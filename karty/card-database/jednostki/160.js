function latest() {
    ...
    const card_description = `
        <p>Ta jednostka zostaje zajęta.</p>
        <br>
        <p>Stwórz i zagraj losową kartę z całego SOLDREC. Nadaj jej status UNICESTWIENIA. Jeżeli zagrasz tym sposobem Dark Lorda, wygrywasz grę.</p>`;
    const card_stats = `
        <p>
        1/1/1/1
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/160.webp";
