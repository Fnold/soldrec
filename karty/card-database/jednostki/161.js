function latest() {
    ...
    const card_description = `
        <p>Zyskujesz 5 zdrowia.</p>
        <br>
        <p>Pod koniec każdej tury ustaw życie tej jednostki na 10.</p>`;
    const card_stats = `
        <p>
        0/0/5/10
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/161.webp";
