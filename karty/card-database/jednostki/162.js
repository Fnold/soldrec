function latest() {
    const card_title = "Oregon";
    const site_title = card_title;
    const card_cost = "5J/10Z 15M";
    const card_cost_info = "≥5 Wystawione Jednostki/10 Zdrowia i 15 Many";
    ...
    const card_description = `
        <p>Poświęć jednostkę inną niż ta.</p>
        <br>
        <p>Za każdym razem, gdy umiera sojuszniczy szarak lub zmieniane jest ułożenie wystawienia sojuszniczych jednostek, połóż licznik na wybranej karcie lub wybrany wróg odrzuca kartę.</p>`;
    const card_stats = `
        <p>
        6/7/7/7
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/162.webp";
