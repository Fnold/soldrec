function latest() {
    const card_title = "Hellfire";
    const site_title = card_title;
    const card_cost = "4Z 4J 15M";
    const card_cost_info = "4 Zdrowia, ≥4 Wystawione Jednostki i 15 Many";
    const card_type = "Jednostka - Operator z Gwiazdką";
    const card_subtype = `
        <p>
        Szef, Człowiek, Przyroda, Mag
        </p>`;
    const card_description = `
        <p>Zwiększ swoje maksymalne zdrowie o X. Zyskujesz X zdrowia, gdzie X jest liczbą zdrowia straconego w tej turze przez wybranego wroga.</p>
        <br>
        <p>Za każdym razem, gdy zajmujesz jednostkę inną niż ta, każdy twój wróg traci 1 zdrowia.</p>`;
    const card_stats = `
        <p>
        7/3/7/7
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/163.webp";
