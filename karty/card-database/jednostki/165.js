function latest() {
    const card_title = "Kondygant";
    const site_title = card_title;
    const card_cost = "10M/5C";
    const card_cost_info = "10 Many/5 Monet";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/165.webp";
