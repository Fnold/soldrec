function latest() {
    const card_title = "Odźwierny Rzemykarz";
    const site_title = card_title;
    const card_cost = "6J 20P";
    const card_cost_info = "≥6 Wystawione Jednostki i 20 Popularności";
    ...
    const card_description = `
        <p>Ta jednostka zyskuje X pkt pancerza, gdzie X jest liczbą jednostek na lewo od tej jednostki.</p>
        <br>
        <p>Wybierz wroga. Ten wróg traci X zdrowia, gdzie X jest liczbą jednostek na prawo od tej jednostki.</p>`;
    const card_stats = `
        <p>
        1/0/0/1
        </p>`;
    const card_flavor = `
        <p>
        Mistrz rzemyków i rzeczy paskopodobnych.
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/166.webp";
