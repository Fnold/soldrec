function latest() {
    ...
    const card_subtype = `
        <p>
        Szarak, Człowiek, Nieumarły
        </p>`;
    const card_description = `
        <p>
        Wybierz jednostkę z twojego cmentarza. Ta jednostka zostaje wskrzeszona.
        </p>`;
    const card_stats = `
        <p>
        9/9/0/9
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/168.webp";
