function latest() {
    const card_title = "Istota Dna";
    const site_title = card_title;
    const card_cost = "2Z 10M";
    const card_cost_info = "2 Zdrowia i 10 Many";
    const card_type = "Jednostka";
    const card_subtype = `
        <p>
        Bestia, Dno, Niszczyciel
        </p>`;
    const card_stats = `
        <p>
        7/7/2/7
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/169.webp";
