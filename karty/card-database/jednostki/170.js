function latest() {
    const card_title = "SOLDIER";
    const site_title = card_title;
    const card_cost = "15Z 5M 15P";
    const card_cost_info = "15 Zdrowia, 5 Many i 15 Popularności";
    ...
    const card_description = `
        <p>
        Każdy twój wróg traci 10 zdrowia.
        </p>`;
    const card_stats = `
        <p>
        5/0/4/3
    ...
    const card_flavor = `
        <i>
        Gonisz za mocą, lecz to JA nią jestem...
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/170.webp";
