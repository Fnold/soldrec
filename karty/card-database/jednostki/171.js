function latest() {
    const card_title = "Gizmo";
    const site_title = card_title;
    const card_cost = "20P/10M";
    const card_cost_info = "20 Popularności/10 Many";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/171.webp";
