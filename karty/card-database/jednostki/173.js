function latest() {
    ...
    const card_subtype = `
        <p>
        Szef, Człowiek, Niszczyciel, Mag
        </p>`;
    const card_description = `
        <p>Zyskujesz X zdrowia, gdzie X jest liczbą zagranych kart w tej turze.</p>
        <br>
        <p>Za każdym razem, gdy zagrasz kartę z kosztem zagrywania zdrowia lub zapłacisz zdrowiem, każdy twój wróg traci X zdrowia, gdzie X jest liczbą straconego zdrowia tym sposobem.</p>`;
    const card_stats = `
        <p>
        6/1/6/6
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/173.webp";
