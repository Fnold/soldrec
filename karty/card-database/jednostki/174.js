function latest() {
    const card_title = "Pustynny Ninja";
    const site_title = card_title;
    const card_cost = "15M 14P";
    const card_cost_info = "15 Many i 14 Popularności";
    ...
    const card_description = `
        <p>
        Za każdym razem, gdy twój wróg straci idealnie 1 zdrowia, traci on 2 zdrowia.
        </p>`;
    const card_stats = `
        <p>
        7/4/7/6
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/174.webp";
