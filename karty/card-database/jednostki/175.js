function latest() {
    const card_title = "Kuszi Diatenko";
    const site_title = card_title;
    const card_cost = "3J/6Z 13M 13P";
    const card_cost_info = "≥3 Wystawione Jednostki/6 Zdrowia, 13 Many i 13 Popularności";
    ...
    const card_description = `
        <p>Ta jednostka zyskuje +X/+0/+0/+0, gdzie X jest jej siłą.</p>
        <br>
        <p>Ta jednostka nie może zostać ulepszona.</p>`;
    const card_stats = `
        <p>
        2/1/1/1
        </p>`;
    const card_flavor = `
        <i>
        "Na Dlonię przybył niejaki Kuszi Diatenko. Nigdy nie był na tej planecie. Pochodzi z Morforu. Szybko zorientował się, że za rozbłysk odpowiada Skji Milo."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/175.webp";
