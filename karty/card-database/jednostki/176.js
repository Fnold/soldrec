function latest() {
    const card_title = "Lights Ami";
    const site_title = card_title;
    const card_cost = "24M";
    const card_cost_info = "24 Many";
    ...
    const card_description = `
        <p>Wybierz wroga. Ten wróg pokazuje ci karty w swojej ręce.</p>
        <br>
        <p>Dobierz 3 karty.</p>
        <br>
        <p>Za każdym razem, gdy twój wróg wybierze tę jednostkę, ten wróg poświęca jednostkę.</p>`;
    const card_stats = `
        <p>
        2/9/8/6
        </p>`;
    const card_flavor = `
        <i>
        "Ostatnie słowa Cesarza niepokoją Skjiego. Powołuje się on na starą legendę, że gdy pojawi się pretendent do tytułu SKKB, czyli władcy świata, zawsze pojawi się on - bohater, który go zabije."
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/176.webp";
