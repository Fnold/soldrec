function latest() {
    const card_title = "Tronin";
    const site_title = card_title;
    const card_cost = "15M/10C 15P";
    const card_cost_info = "15 Many/10 Monet i 15 Popularności";
    const card_type = "Jednostka - Operator z Gwiazdką";
    const card_subtype = `
        <p>
        Szef, Człowiek, Demon, Mag
        </p>`;
    const card_description = `
        <p>Poświęć 2 jednostki, a następnie zmień stronę wybranej jednostki.</p>
        <br>
        <p>Jednostki, których jesteś włodarzem, ale nie jesteś oryginalnym włodarzem, nie mogą zostać zablokowane ani zdegradowane.</p>`;
    const card_stats = `
        <p>
        4/4/5/4
        </p>`;
    const card_flavor = `
        <i>
        "Wokół niego znajdowało się pełne wysypisko gruzów po jego domu i sąsiadach. Szybko wpadł w furię. Zrobił odruchowo coś, czego jeszcze nigdy nie robił - zamiast nakładać magię na przedmioty nałożył ją na siebie."
        </i>`;
    const card_author = `
        <i>
        Ilustracja: Soldin 2025
        </i>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/177.webp";
