function latest() {
    ...
    const card_subtype = `
        <p>
        Szarak, Przyroda, Bestia, Mag
        </p>`;
    const card_description = `
        <p>
        Ta jednostka ma NIEWRAŻLIWOŚĆ.
        </p>`;
    const card_stats = `
        <p>
        3/4/4/8
    ...
    const card_flavor = `
        <p>
        "Przybył więc do nas kolejny idiota..."
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/178.webp";
