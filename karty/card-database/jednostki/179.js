function latest() {
    const card_title = "Nembik";
    const site_title = card_title;
    const card_cost = "10M 20P";
    const card_cost_info = "10 Many i 20 Popularności";
    const card_type = "Jednostka - Operator Szarak";
    const card_subtype = `
        <p>
        Szarak, Kler, Niszczyciel, Mag
        </p>`;
    const card_description = `
        <p>
        Wybierz jednostkę i kombinację kolorów. Wybrana jednostka ma wybraną kombinację kolorów.
        </p>`;
    const card_stats = `
        <p>
        5/5/5/5
    ...
    const card_flavor = `
        <p>
        "Nie ważne co zrobisz, historia będzie dalej trwała jak ja, który trwałem przy nich przez cały ten czas."
        </p>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/179.webp";
