function latest() {
    ...
    const card_cost = "14M 20P";
    const card_cost_info = "14 Many i 20 Popularności";
    ...
    const card_description = `
        <p>Możesz poświęcić akcję. Jeżeli to zrobisz, dobierz 2 karty.</p>
        <br>
        <p>Za każdym razem, gdy zagrywasz kartę możesz rzucić monetą:
        <br>
        ORZEŁ - Stwórz kopię zagrywanej karty.
        <br>
        RESZKA - Usuń zagrywaną kartę z gry.
        </p>`;
    const card_stats = `
        <p>
        0/4/5/1
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/180.webp";
