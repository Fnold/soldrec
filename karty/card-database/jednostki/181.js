function latest() {
    ...
    const card_description = `
        <p>
        Zagrywane przez twoich wrogów karty kosztują 3 mniej many, popularności, monet i zdrowia.
        </p>`;
    const card_stats = `
        <p>
        10/10/10/10
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/181.webp";
