function latest() {
    ...
    const card_subtype = `
        <p>
        Szef, Nieumarły, Niszczyciel
        </p>`;
    const card_description = `
        <p>Przewiduj 5 lub zrzuć 5 kart.</p>
        <br>
        <p>Twoja talia nie może zostać przetasowana ani nie można zmienić jej ułożenia.</p>`;
    const card_stats = `
        <p>
        0/3/3/2
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/182.webp";
