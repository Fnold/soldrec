function latest() {
    const card_title = "Brodiaga";
    const site_title = card_title;
    const card_cost = "9M 3P";
    const card_cost_info = "9 Many i 3 Popularności";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/183.webp";
