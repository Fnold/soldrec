function latest() {
    ...
    const card_flavor = `
        <i>
        "Ludzie myślą o oprogramowaniu jak o czymś, co nie może zawieść. Jak kod może się wygiąć niczym stalowy element czy stłuczyć jak szyba? Fałsz." - ROgueBOT
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/184.webp";
