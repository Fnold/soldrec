function latest() {
    const card_title = "Maria";
    const site_title = card_title;
    const card_cost = "9M/4C";
    const card_cost_info = "9 Many/4 Monety";
    ...
    const card_flavor = `
        <i>
        "Nadal możemy się spiknąć, wiesz?"
        </i>`;
    const card_author = `
        <i>
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/185.webp";
