function latest() {
    const card_title = "Dźwiedź";
    const site_title = card_title;
    const card_cost = "15M 1P";
    const card_cost_info = "15 Many i 1 Popularności";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/186.webp";
