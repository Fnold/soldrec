function latest() {
    ...
    const card_cost = "15M 8P";
    const card_cost_info = "15 Many i 8 Popularności";
    ...
    const card_description = `
        ...
        <br>
        <p>Pod koniec każdej sojuszniczej tury ulepsz tę jednostkę X razy, gdzie X jest liczbą niewykorzystanej many z tej tury.</p>`;
    const card_stats = `
        <p>
        3/3/3/3
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/46.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `&gt;<u>Najnowsza</u>`;
    document.getElementById("v1_3_0_selector").innerHTML = `<u>v1.3.0</u>`;
    document.getElementById("v1_2_0_selector").innerHTML = `<u>v1.2.0</u>`;
    document.getElementById("v1_0_0_selector").innerHTML = `<u>v1.0.0</u>`;
    document.getElementById("alpha_selector").innerHTML = `<u>Alpha</u>`;
}
function v1_3_0() {
    const card_title = "SKKB";
    const site_title = card_title+" (v1.3.0)";
    const card_cost = "14M 8P";
    const card_cost_info = "14 Many i 8 Popularności";
    const card_type = "Jednostka - Operator z Gwiazdką";
    const card_subtype = `
        <p>
        Szef, Człowiek, Demon, Niszczyciel
    ...
    document.getElementById("card_stats").innerHTML = card_stats;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/1.3.0/jednostki/46.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_3_0_selector").innerHTML = `&gt;<u>v1.3.0</u>`;
    document.getElementById("v1_2_0_selector").innerHTML = `<u>v1.2.0</u>`;
...
function v1_2_0() {
    ...
    document.getElementById("card_stats").innerHTML = card_stats;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/1.2.0/jednostki/46.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_3_0_selector").innerHTML = `<u>v1.3.0</u>`;
    document.getElementById("v1_2_0_selector").innerHTML = `&gt;<u>v1.2.0</u>`;
...
function v1_0_0() {
    ...
    document.getElementById("card_stats").innerHTML = card_stats;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/1.0.0/jednostki/46.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_3_0_selector").innerHTML = `<u>v1.3.0</u>`;
    document.getElementById("v1_2_0_selector").innerHTML = `<u>v1.2.0</u>`;
...
function alpha() {
    ...
    document.getElementById("card_stats").innerHTML = card_stats;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/jednostki/46.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("v1_2_0_selector").innerHTML = `<u>v1.2.0</u>`;
    document.getElementById("v1_0_0_selector").innerHTML = `<u>v1.0.0</u>`;
