function latest() {
    const card_title = "Omnibus Liczenia";
    const site_title = card_title;
    const card_cost = "7M 6P";
    const card_cost_info = "7 Many i 6 Popularności";
    const card_type = "Jednostka";
    const card_subtype = `
        <p>
        Maszyna, Niszczyciel, Mag
        </p>`;
    const card_stats = `
        <p>
        4/3/4/7
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/5.webp";
