function latest() {
    ...
    const card_cost = "5J";
    const card_cost_info = "≥5 Wystawione Jednostki";
    ...
    const card_description = `
        <p>Pokaż górną kartę twojej talii. Jeżeli jest to jednostka, dobierz te kartę.</p>
        <br>
        <p>Za każdym razem, gdy ta jednostka atakuje, zyskuje ona +X/+0/+0/+0, gdzie X jest liczbą atakujących jednostek.</p>`;
    const card_stats = `
        <p>
        3/2/3/3
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/52.webp";
...
function alpha() {
    ...
    document.getElementById("card_stats").innerHTML = card_stats;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/jednostki/52.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
