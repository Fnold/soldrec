function latest() {
    ...
    const card_description = `
        ...
        <br>
        <p>Za każdym razem, gdy akcja wybiera tylko jedną jednostkę, możesz zdecydować czy ma ona także wybrać Posuwacza.</p>`;
    const card_stats = `
        <p>
        7/4/7/7
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/62.webp";
...
function alpha() {
    ...
    document.getElementById("card_stats").innerHTML = card_stats;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/jednostki/62.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
