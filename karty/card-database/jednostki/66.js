function latest() {
    ...
    const card_description = `
        <p>Wybierz wroga. Ten wróg zrzuca X kart, gdzie X jest liczbą sojuszniczych akcji.</p>
        <br>
        <p>Za każdym razem, gdy sojusznicza akcja zadaje obrażenia wrogowi, ten wróg zrzuca X kart, gdzie X jest liczbą zadanych obrażeń.</p>`;
    const card_stats = `
        <p>
        9/8/3/2
        </p>`;
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/66.webp";
...
function alpha() {
    ...
    document.getElementById("card_stats").innerHTML = card_stats;
    document.getElementById("card_author").innerHTML = card_author;
    document.getElementById("card_image").src = "../../assets/cards/alpha/jednostki/66.webp";
    document.getElementById("card_image").alt = card_title;
    document.getElementById("latest_selector").innerHTML = `<u>Najnowsza</u>`;
    document.getElementById("alpha_selector").innerHTML = `&gt;<u>Alpha</u>`;
}
