function latest() {
    const card_title = "Matka Jakiegoś Pedofila";
    const site_title = card_title;
    const card_cost = "5M 1P";
    const card_cost_info = "5 Many i 1 Popularności";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/78.webp";
