function latest() {
    ...
    const card_subtype = `
        <p>
        Człowiek, Bogacz, Morska, Niszczyciel
        </p>`;
    const card_stats = `
        <p>
        7/7/7/7
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/83.webp";
