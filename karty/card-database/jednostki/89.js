function latest() {
    const card_title = "Bożydariusz";
    const site_title = card_title;
    const card_cost = "19M 11P";
    const card_cost_info = "19 Many i 11 Popularności";
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/89.webp";
