function latest() {
    const card_title = "Prospektor";
    const site_title = card_title;
    const card_cost = "2C";
    const card_cost_info = "2 Monety";
    const card_type = "Jednostka";
    const card_subtype = `
        <p>
        Człowiek, Przyroda, Bogacz
        </p>`;
    const card_stats = `
        <p>
        0/3/4/4
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/93.webp";
