function latest() {
    const card_title = "Pirat";
    const site_title = card_title;
    const card_cost = "3J 2C";
    const card_cost_info = "≥3 Wystawione Jednostki i 2 Monety";
    const card_type = "Jednostka";
    const card_subtype = `
        <p>
        Człowiek, Morska, Niszczyciel
        </p>`;
    const card_stats = `
        <p>
        4/0/5/5
    ...
    document.getElementById("card_image").src = "../../assets/cards/latest/jednostki/96.webp";
